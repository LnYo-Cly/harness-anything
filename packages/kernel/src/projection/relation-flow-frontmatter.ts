...
function isRelationType(value: string): value is EntityRelationRecord["type"] {
  return ["supports", "supersedes", "refines", "narrows", "derives", "blocks", "relates", "implements", "depends-on", "produces", "evidences", "evidenced-by", "refutes", "invalidated-by", "supersedes-fact"].includes(value);
}
