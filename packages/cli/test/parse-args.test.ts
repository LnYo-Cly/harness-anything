...
const parseCases: ReadonlyArray<ParseCase> = [
  ...
  { name: "decision accept", argv: ["decision", "accept", "dec_TEST", "--arbiter", "human:ZeyuLi", "--judgment-only", "Manual judgment", "--standing-policy"], kind: "decision-accept", fields: { decisionId: "dec_TEST", arbiter: "human:ZeyuLi", judgmentOnlyRationale: "Manual judgment", standingPolicy: true } },
