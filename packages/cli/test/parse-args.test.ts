...
const parseCases: ReadonlyArray<ParseCase> = [
  ...
  { name: "task review execution", argv: ["task", "review-execution", "task_1", "--execution-id", "exe_1", "--verdict", "approved", "--findings", "ship it", "--acknowledge-archive-warnings"], kind: "task-review-execution", fields: { taskId: "task_1", executionId: "exe_1", verdict: "approved", findings: "ship it", archiveWarningsAcknowledged: true } },
