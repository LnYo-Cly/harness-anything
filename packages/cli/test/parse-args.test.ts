...
const parseCases: ReadonlyArray<ParseCase> = [
  ...
  { name: "preset run allow scripts", argv: ["preset", "run", "publish-standard", "plan", "--task", "task_1", "--allow-scripts", "--input", "mode=smoke", "--input", "phase=plan"], kind: "preset-run", fields: { presetId: "publish-standard", entrypoint: "plan", taskId: "task_1", allowScripts: true, inputs: { mode: "smoke", phase: "plan" } } },
  ...
  { name: "preset action allow scripts", argv: ["preset", "action", "publish-standard", "scaffold", "--task", "task_1", "--allow-scripts", "--input", "mode=agent-smoke"], kind: "preset-action", fields: { presetId: "publish-standard", actionName: "scaffold", taskId: "task_1", allowScripts: true, inputs: { mode: "agent-smoke" } } },
