...
const parseCases: ReadonlyArray<ParseCase> = [
  ...
  { name: "migrate retired attribution fields", argv: ["migrate", "retired-attribution-fields", "--apply", "--confirm-plan", "rafm_123", "--evidence-ref", "task/task_1/artifacts/report.md#sha256:test", "--batch-size", "16"], kind: "migrate-retired-attribution-fields", fields: { mode: "apply", confirmPlan: "rafm_123", evidenceRef: "task/task_1/artifacts/report.md#sha256:test", batchSize: 16 } },
