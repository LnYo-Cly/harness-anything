...
const explicitInputDescriptors = {
  ...
  "decision-propose": {
    ...
    properties: {
      ...
      chosen: { type: ["string", "array"], description: "Chosen option text, or an array whose first item has text.", items: { type: "object", properties: { text: { type: "string" } } } },
      rejected: { type: ["string", "array"], description: "Rejected option text, or an array whose first item has text and whyNot.", items: { type: "object", properties: { text: { type: "string" }, whyNot: { type: "string" } } } },
