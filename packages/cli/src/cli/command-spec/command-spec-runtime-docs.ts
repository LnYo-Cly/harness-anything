...
export const runtimeDocsCommandSpecs = defineCommandSpecs([
  {
    ...
    "aliasDisplay": {"runtime-event append (deprecated, use event append; retires at E77/F6 acceptance)":"hidden"},
  ...
  },
  {
    ...
    "aliasDisplay": {"runtime-event list (deprecated, use event list; retires at E77/F6 acceptance)":"hidden"},
