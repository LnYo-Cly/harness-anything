...
export const migrationDiagnosticsCommandSpecs = defineCommandSpecs([
  ...
  },
  {
    ...
    "aliasDisplay": {"migrate-plan (deprecated, use migrate plan; retires at E77/F6 acceptance)":"hidden"},
  ...
  },
  {
    ...
    "aliasDisplay": {"migrate-structure (deprecated, use migrate structure; retires at E77/F6 acceptance)":"hidden"},
  ...
  },
  {
    ...
    "aliasDisplay": {"migrate-anchors (deprecated, use migrate anchors; retires at E77/F6 acceptance)":"hidden"},
  ...
  },
  {
    ...
    "aliasDisplay": {"migrate-provenance (deprecated, use migrate provenance; retires at E77/F6 acceptance)":"hidden"},
  ...
  },
  {
    ...
    "aliasDisplay": {"migrate-run (deprecated, use migrate run; retires at E77/F6 acceptance)":"hidden"},
  ...
  },
  {
    ...
    "aliasDisplay": {"legacy intake-plan <path> (deprecated, use legacy plan; retires at E77/F6 acceptance)":"hidden"},
  ...
  },
  {
    ...
    "aliasDisplay": {"legacy copy-safe-docs <path> (deprecated, use legacy copy-docs; retires at E77/F6 acceptance)":"hidden"},
  ...
  },
  {
    ...
    "aliasDisplay": {"git-diff (deprecated, use git diff; retires at E77/F6 acceptance)":"hidden"},
