...
export const commandRegistry = [
  { kind: "init", primary: "harness init [--add-npm-scripts]", resultEnvelope: "CliResult/v1" },
  { kind: "new-task", primary: "harness new-task --title <title> [--vertical software/coding --preset <id> --module <key>] [--register-module <key> --module-title <title> --module-scope <path>] [--long-running] [--dry-run] [--locale zh-CN|en-US] [--from-legacy <legacy-id>] [--json]", resultEnvelope: "CliResult/v1" },
  { kind: "status-set", primary: "harness task status set <id> <status> [--force --reason <reason>]", resultEnvelope: "CliResult/v1" },
  { kind: "progress-append", primary: "harness task progress append <id> --text <text> [--evidence type:PATH:summary]", resultEnvelope: "CliResult/v1" },
  { kind: "task-archive", primary: "harness task archive <id> --reason <reason> [--archived-by <actor>] [--archive-field <field>]", resultEnvelope: "CliResult/v1" },
  { kind: "task-supersede", primary: "harness task supersede <old-id> (--title <title> [--slug <slug>] | --by <existing-task-id> --confirm <old-id>) [--allow-open-findings]", resultEnvelope: "CliResult/v1" },
  { kind: "task-delete", primary: "harness task delete (--soft <id> | --hard <id> --confirm <id>) --reason <reason> [--deleted-by <actor>]", resultEnvelope: "CliResult/v1" },
  ...
  { kind: "task-list", primary: "harness task list [--state <state>] [--module <key>] [--queue <queue>] [--preset <id>] [--review <state>] [--lesson [present|missing]] [--missing-materials] [--include-archived] [--search <text>] [--json]", resultEnvelope: "CliResult/v1" },
  ...
  { kind: "migrate-run", primary: "harness migrate-run [--plan-only] [--out-dir folder] [--session-dir folder] [--locale zh-CN|en-US] [--assume-locale zh-CN|en-US] [--allow-dirty] [--json]", resultEnvelope: "CliResult/v1" },
  ...
  { kind: "preset-run", primary: "harness preset run <id> <plan|scaffold|check> --task <id> [--allow-scripts] [--json]", resultEnvelope: "CliResult/v1" },
  { kind: "preset-action", primary: "harness preset action <id> <action> --task <id> [--allow-scripts] [--json]", resultEnvelope: "CliResult/v1" },
  ...
  { kind: "module-register", primary: "harness module register <key> --title <title> --scope <path> [--prefix <prefix>] [--status <status>] [--branch <branch>] [--owner <owner>] [--current-step <step>] [--shared <path>] [--depends-on <module>] [--json]", resultEnvelope: "CliResult/v1" },
