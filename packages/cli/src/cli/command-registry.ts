...
const commandUsages = [
  ...
  { kind: "decision-list", usage: "decision list [--search <text>] [--legacy-id E<n>] [--legacy-range E<n>-E<n>] [--compact] [--json]" },
...
const commandExamples = {
  ...
  "decision-list": [`${cliCommandName} decision list --legacy-range E1-E71 --compact --json`],
